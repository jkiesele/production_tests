...
options.setDefault('outputFile', 'file:pileupTest.root')
...
process.selGenJetsPlus = cms.EDFilter("EtaPtMinCandViewSelector",
...
process.selGenJetsMinus = cms.EDFilter("EtaPtMinCandViewSelector",
    src = cms.InputTag("ak4GenJetsNoNu"),
    ptMin = cms.double(3),
...
process.filterPlus = cms.EDFilter("CandViewCountFilter",
    src = cms.InputTag("selGenJetsPlus"),
    minNumber = cms.uint32(1)
)

process.filterMinus = cms.EDFilter("CandViewCountFilter",
    src = cms.InputTag("selGenJetsMinus"),
    minNumber = cms.uint32(1)
)

process.seqFilterJets = cms.Sequence(process.selGenJetsPlus*process.selGenJetsMinus*process.filterPlus*process.filterMinus)
process.generation_step *= process.seqFilterJets
